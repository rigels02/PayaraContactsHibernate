...
@Inject
    ...
    public Response retrieveContactById(@PathParam("id") long id) {
        ...
        log.log(Level.INFO, "findById {0}: found Contact = {1} {2} {3} {4} {5} {6}", 
                new Object[]{id, contact.getFirstName(), contact.getLastName(), 
                    contact.getEmail(), contact.getPhoneNumber(), contact.getBirthDate(), 
                    contact.getId()});
    ...
    public Response createContact(Contact contact) {
        log.log(Level.INFO, "createContact started. Contact = {0} {1} {2} {3} {4} {5}", 
        ...
        try {
            ...
            log.log(Level.INFO, "createContact completed. Contact = {0} {1} {2} {3} {4} {5}", 
    ...
    public Response updateContact(@PathParam("id") long id, Contact contact) {
        ...
        log.log(Level.INFO, "updateContact started. Contact = {0} {1} {2} {3} {4} {5}", 
                new Object[]{contact.getFirstName(), contact.getLastName(), 
                    contact.getEmail(), contact.getPhoneNumber(), 
                    contact.getBirthDate(), contact.getId()});
        ...
        try {
            ...
            log.log(Level.INFO, "updateContact completed. Contact = {0} {1} {2} {3} {4} {5}", 
                    new Object[]{contact.getFirstName(), contact.getLastName(),
                        contact.getEmail(), contact.getPhoneNumber(), 
                        contact.getBirthDate(), contact.getId()});
        } catch (ConstraintViolationException ce) {
    ...
    public Response deleteContact(@PathParam("id") Long id) {
        ...
        try {
            ...
            log.log(Level.INFO, "deleteContact completed. Contact = {0} {1} {2} {3} {4} {5}", 
                    new Object[]{contact.getFirstName(), contact.getLastName(), 
                        contact.getEmail(), contact.getPhoneNumber(), 
                        contact.getBirthDate(), contact.getId()});
        } catch (Exception e) {
